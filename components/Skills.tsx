...
export default function Skills() {
  ...
  return (
    <section id="skills" className="py-32 relative overflow-hidden" style={{ background: 'var(--background)' }}>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.div 
            ...
            className="h-1 bg-gradient-to-r from-purple-500 to-pink-500 mb-20 rounded-full" 
          />
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {skillCategories.map((category, categoryIndex) => (
              ...
              >
                ...
                <h3 className={`text-xl md:text-2xl font-bold mb-8 leading-tight relative z-10 group-hover:text-purple-400 transition-colors ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{category.category}</h3>
                <div className="flex flex-wrap gap-3">
                  {category.skills.map((skill, skillIndex) => (
                    <motion.span
                      ...
                      className={`px-5 py-2.5 rounded-full text-sm md:text-base font-medium border transition-all cursor-default relative z-10 ${
                        theme === 'dark'
