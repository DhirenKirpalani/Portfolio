...
export default function About() {
  ...
  return (
    <section id="about" className="py-32 relative overflow-hidden" style={{ background: 'var(--background)' }}>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.div 
            ...
            className="h-1 bg-gradient-to-r from-blue-500 to-purple-500 mb-16 rounded-full" 
          />
          ...
          <div className="grid md:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              <h3 className={`text-2xl md:text-3xl font-bold mb-8 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>Focus Areas</h3>
