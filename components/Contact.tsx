...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-32 relative overflow-hidden" style={{ background: 'var(--background)' }}>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.div 
            ...
            className="h-1 bg-gradient-to-r from-blue-500 to-purple-500 mb-10 mx-auto rounded-full" 
          />
          ...
          >
            <div className="space-y-6">
              ...
              <motion.button
                ...
                className="w-full px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-lg font-semibold hover:from-blue-600 hover:to-purple-600 transition-all shadow-lg shadow-blue-500/50 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {status === 'loading' ? (
                  <>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            {contactLinks.map((link, index) => (
              <motion.a
                ...
                className={`flex items-center gap-5 p-8 rounded-lg border transition-all group relative overflow-hidden ${
                  theme === 'dark'
              ...
              >
                ...
                <div className={`w-14 h-14 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform flex-shrink-0 relative z-10 ${theme === 'dark' ? 'bg-gradient-to-br from-blue-500/20 to-purple-500/20' : 'bg-gradient-to-br from-blue-100 to-purple-100'}`}>
                  <link.icon className={`w-7 h-7 ${theme === 'dark' ? 'text-blue-400 group-hover:text-blue-300' : 'text-blue-600 group-hover:text-blue-700'}`} />
                </div>
                <div className="text-left relative z-10">
                  <div className={`text-sm mb-2 font-medium ${theme === 'dark' ? 'text-gray-500' : 'text-gray-600'}`}>{link.label}</div>
                  <div className={`font-semibold text-base md:text-lg group-hover:text-blue-400 transition-colors ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
                    {link.value}
                  </div>
                </div>
              </motion.a>
