...
export default function Contact() {
    ...
    return (
        ...
        >
            ...
            <p className="text-gray-700 -mt-6 dark:text-white/80">Please contact me at{" "} <a className="underline" href="mailto:dhirenkirpalani2308@gmail.com">dhirenkirpalani2308@gmail.com</a>{" "} or through this form.</p>
